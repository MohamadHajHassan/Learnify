...
const footer = () => {
    return (
        <footer className='py-20 border-white shadow-lg border-t-2 bg-cyan-950 flex flex-col items-center justify-items-center'>
            ...
            <p className="text-white text-center mt-5 desc-style">Learnify</p>
            <p className="mt-5 text-center text-gray-200"><span className="af-be">All Copy Rights Reserved @2024</span></p>
        </footer>
    )
}
